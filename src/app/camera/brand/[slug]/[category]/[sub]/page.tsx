...
import { inferCameraBrandFromSlug, slugToCameraCategory, CAMERA_PRODUCT_CATEGORIES, CAMERA_TYPE_TAGS, cameraProductUrl, CAMERA_SUBCATEGORY_SLUG_MAP, slugToCameraSubcategory } from "@/lib/camera/constants";
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand || !category || !subcategory || !(CAMERA_PRODUCT_CATEGORIES as readonly string[]).includes(category)) {
