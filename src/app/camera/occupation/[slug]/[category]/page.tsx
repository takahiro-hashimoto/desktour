...
import { CAMERA_OCCUPATION_TAGS, slugToCameraOccupation, slugToCameraCategory, CAMERA_PRODUCT_CATEGORIES, CAMERA_TYPE_TAGS, cameraProductUrl } from "@/lib/camera/constants";
