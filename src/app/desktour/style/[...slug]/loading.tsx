  ...
  return (
    <div className="max-w-[1080px] mx-auto px-4 py-12">
      ...
      <div className="text-center mb-16">
        ...
        <div className="h-12 w-40 bg-gray-200 rounded animate-pulse mx-auto mb-2" />
        <div className="h-5 w-24 bg-gray-200 rounded animate-pulse mx-auto mb-6" />
