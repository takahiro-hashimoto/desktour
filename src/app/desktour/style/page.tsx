...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { title, description, url: "/desktour/style", type: "website" },
...
const STYLE_DESCRIPTIONS: Record<string, string> = {
  ...
  "ナチュラル": "木目・自然素材・北欧デザインを取り入れた温かみのあるセットアップで使用されているガジェットを紹介。",
  "インダストリアル": "アイアンや古材を使った無骨なセットアップで使用されているガジェットを紹介。",
  "かわいい": "パステルカラーや可愛いアイテムで構成されたセットアップで使用されているガジェットを紹介。",
  "ダーク": "ダークウッドや間接照明を取り入れた落ち着いた雰囲気のセットアップで使用されているガジェットを紹介。",
