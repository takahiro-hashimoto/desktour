...
export function CameraFeaturedSection({ items }: FeaturedSectionProps) {
  return (
      ...
      <div className="home-featured__inner">
        <div className="home-featured__head">
          <div>
            ...
            <p className="home-featured__subtitle">最近追加された撮影機材紹介の動画、記事の中からおすすめを紹介</p>
          </div>
          <Link href="/camera/sources" className="home-featured__more">
            全て見る
            ...
            <Link href={item.href} className="home-featured__card">
              <figure className="home-featured__thumb">
                {item.thumbnail_url ? (
                  ...
                  <div className="home-featured__thumb-placeholder">CAMERA GEAR</div>
                )}
                {item.badge && (
              ...
              <div className="home-featured__body">
                ...
                {item.product_count !== undefined && item.product_count > 0 && (
                  <div className="home-featured__products">
                    <i className="fa-solid fa-link"></i> 紹介機材: {item.product_count}件
                  </div>
                )}
                {item.tags.length > 0 && (
