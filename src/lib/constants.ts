...
// ------------------------------------------------------------
// 種類タグ定義（多軸構造）
// カテゴリごとに分類軸を分け、各軸は排他（最大1つ）で選択する
// ------------------------------------------------------------

/** 多軸タグの型定義 */
export interface TypeTagAxis {
  axis: string;       // 軸名（例: "スイッチ方式", "サイズ"）
  tags: string[];     // その軸のタグ一覧
}

/** カテゴリ → 軸配列のマッピング */
export const TYPE_TAGS_MULTI_AXIS: Record<string, TypeTagAxis[]> = {
  "キーボード": [
    { axis: "スイッチ方式", tags: ["メカニカルキーボード", "静電容量無接点", "パンタグラフ"] },
    { axis: "サイズ", tags: ["フルサイズ", "テンキーレス", "60%・65%"] },
    { axis: "形状", tags: ["分割キーボード", "ロープロファイル"] },
  ],
  "マウス": [
    { axis: "操作方式", tags: ["通常マウス", "トラックボール", "縦型マウス"] },
  ],
  "ディスプレイ・モニター": [
    { axis: "解像度", tags: ["フルHD", "4K", "5K・6K"] },
    { axis: "アスペクト比", tags: ["標準（16:9）", "ウルトラワイド"] },
  ],
  "モバイルモニター": [
    { axis: "サイズ", tags: ["13インチモバイルモニター", "15インチモバイルモニター"] },
    { axis: "機能", tags: ["タッチ対応モバイルモニター"] },
  ],
  "ヘッドホン・イヤホン": [
    { axis: "形状", tags: ["ヘッドホン", "イヤホン"] },
    { axis: "ハウジング", tags: ["開放型", "密閉型"] },
    { axis: "用途", tags: ["モニター用", "ゲーミング", "リスニング"] },
  ],
  "チェア": [
    { axis: "構造", tags: ["ゲーミングチェア", "メッシュチェア", "バランスチェア"] },
  ],
  "デスク": [
    { axis: "機構", tags: ["固定デスク", "昇降デスク"] },
    { axis: "形状", tags: ["ストレートデスク", "L字デスク"] },
  ],
  "マイク": [
    { axis: "種類", tags: ["コンデンサーマイク", "ダイナミックマイク", "ピンマイク"] },
    { axis: "接続", tags: ["USB", "XLR"] },
  ],
  "スピーカー": [
    { axis: "形状", tags: ["ブックシェルフ型", "サウンドバー"] },
  ],
  "照明・ライト": [
    { axis: "種類", tags: ["デスクライト", "モニターライト", "間接照明", "リングライト", "LEDテープ"] },
  ],
  "ウェブカメラ": [
    { axis: "解像度", tags: ["フルHD", "4K"] },
  ],
  "PC本体": [
    { axis: "形態", tags: ["デスクトップPC", "ノートPC", "ミニPC", "自作PC"] },
    { axis: "OS", tags: ["Mac", "Windows"] },
  ],
  "HDD・SSD": [
    { axis: "形態", tags: ["外付けSSD", "外付けHDD", "内蔵SSD", "内蔵HDD"] },
  ],
  "コントローラー": [
    { axis: "種類", tags: ["ゲームパッド", "レーシングホイール", "アーケードスティック"] },
  ],
  "キャプチャーボード": [
    { axis: "形態", tags: ["外付け", "内蔵"] },
  ],
  "NAS": [
    { axis: "ベイ数", tags: ["2ベイ", "4ベイ"] },
  ],
  "マイクアーム": [
    { axis: "種類", tags: ["デスクマウント型マイクアーム", "クランプ式マイクアーム", "ロープロファイルマイクアーム"] },
  ],
  "充電器・電源タップ": [
    { axis: "種類", tags: ["USB充電器", "ワイヤレス充電器", "電源タップ", "ポータブル電源"] },
  ],
  "配線整理グッズ": [
    { axis: "種類", tags: ["ケーブルトレイ", "ケーブルクリップ", "ケーブルチューブ", "ケーブルボックス", "マジックテープ", "ケーブルホルダー"] },
  ],
  "モニターアーム": [
    { axis: "構成", tags: ["シングルアーム", "デュアルアーム"] },
  ],
  "ペンタブ": [
    { axis: "種類", tags: ["板タブ", "液タブ"] },
  ],
};

// 後方互換: フラットな TYPE_TAGS を多軸構造から生成
